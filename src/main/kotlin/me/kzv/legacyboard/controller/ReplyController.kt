...
class ReplyController(
    ...
    fun createReply( @PathVariable boardId: Long, @RequestBody dto: CreateReplyRequestDto, authentication: Authentication):ResponseEntity<Any>{
        val member = authentication.principal as Member
        replyService.create(dto.content, boardId, member)
